                ...
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <div class="row m-b-sm m-t-sm">
                            ...
                            <div class="col-md-11">
                                <form role="form" class="form-inline" action="<?php echo U('Workshop/export');?>" method="post" id="export">
    ...
    <script>
        ...
        var apply = new Vue({
            ...
            methods : {
                // 刷新
                relaod : function () {
                    $.get("<?php echo U('Workshop/lists');?>", function (data) {
                        if (data.status) {
                ...
                submit : function () {
                    $.post("<?php echo U('Workshop/approve');?>", {
                        aid : this.info.id,
                        type : this.type,
