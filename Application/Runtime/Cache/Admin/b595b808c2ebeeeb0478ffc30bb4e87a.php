...
<html lang="en">
	...
	<head>
		...
		<link href="/audit/Public/assets/css/bootstrap.min.css" rel="stylesheet" />
		...
		<!--[if IE 7]>
		  ...
		  <link rel="stylesheet" href="/audit/Public/assets/css/font-awesome-ie7.min.css" />
		...
		<link rel="stylesheet" href="/audit/Public/assets/css/ace.min.css" />

		<link rel="stylesheet" href="/audit/Public/assets/css/ace-rtl.min.css" />

		<link rel="stylesheet" href="/audit/Public/assets/css/ace-skins.min.css" />



		<!--[if lte IE 8]>

		  <link rel="stylesheet" href="/audit/Public/assets/css/ace-ie.min.css" />
		...
		<script src="/audit/Public/assets/js/ace-extra.min.js"></script>
		...
		<script src="/audit/Public/assets/js/html5shiv.js"></script>

		<script src="/audit/Public/assets/js/respond.min.js"></script>
					...
					<ul class="nav ace-nav">
							...
							<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								...
								<li>
									...
									<a href="#">
										...
										<img src="/audit/Public/assets/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
								...
								<li>
									...
									<a href="#">
										...
										<img src="/audit/Public/assets/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
								...
								<li>
									...
									<a href="#">
										...
										<img src="/audit/Public/assets/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
						...
						<li class="light-blue">
							...
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								...
								<img class="nav-user-photo" src="/audit/Public/assets/avatars/user.jpg" alt="Jason's Photo" />
												...
												<div class="timeline-items">
													...
													<div class="timeline-item clearfix">
														...
														<div class="timeline-info">
															...
															<img alt="Susan't Avatar" src="/audit/Public/assets/avatars/avatar1.png" />
																...
																<div class="widget-main">
																	...
																	<div class="clearfix">
																		...
																		<div class="pull-right">
																			...
																			<img alt="Image 4" width="36" src="/audit/Public/assets/images/gallery/thumb-4.jpg" />

																			<img alt="Image 3" width="36" src="/audit/Public/assets/images/gallery/thumb-3.jpg" />

																			<img alt="Image 2" width="36" src="/audit/Public/assets/images/gallery/thumb-2.jpg" />

																			<img alt="Image 1" width="36" src="/audit/Public/assets/images/gallery/thumb-1.jpg" />
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			window.jQuery || document.write("<script src='/audit/Public/assets/js/jquery-2.0.3.min.js'>"+"<"+"/script>");
...
<script type="text/javascript">
 ...
 window.jQuery || document.write("<script src='/audit/Public/assets/js/jquery-1.10.2.min.js'>"+"<"+"/script>");
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			if("ontouchend" in document) document.write("<script src='/audit/Public/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");

		</script>

		<script src="http://www.jq22.com/jquery/bootstrap-3.3.4.js"></script>

		<script src="/audit/Public/assets/js/typeahead-bs2.min.js"></script>
		...
		<script src="/audit/Public/assets/js/ace-elements.min.js"></script>

		<script src="/audit/Public/assets/js/ace.min.js"></script>
