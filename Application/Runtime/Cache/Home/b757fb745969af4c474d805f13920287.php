...
<html lang="en-us">
	<head>
		...
		<!-- FAVICONS -->
		<link rel="shortcut icon" href="/apply/Public/home/img/favicon/favicon.ico" type="image/x-icon">
		<link rel="icon" href="/apply/Public/home/img/favicon/favicon.ico" type="image/x-icon">
		<style>
			#main {
				margin-left: 0;
			}
						...
						<div class="jarviswidget jarviswidget-color-blue jarviswidget-sortable" id="wid-id-1" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" role="widget" style="">
								...
								<table id="user" class="table table-bordered table-striped" style="clear: both">
									<tbody>
										...
										<tr>
											<td style="width:35%;"><span class="text-primary">展架数量</span></td>
											<td style="width:65%"><span class="text-info"><?php echo ($data["info"]["number"]); ?></span></td>
										</tr>
										<tr>
										...
										<tr>
											<td style="width:35%;"><span class="text-primary">摆放地点</span></td>
											<td style="width:65%"><span class="text-info"><?php echo ($data["info"]["place"]); ?></span></td>
										</tr>
									</tbody>
								</table>
