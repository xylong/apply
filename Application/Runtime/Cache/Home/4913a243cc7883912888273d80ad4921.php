						...
						<div class="jarviswidget jarviswidget-color-blue jarviswidget-sortable" id="wid-id-1" data-widget-colorbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" role="widget" style="">
								...
								<table id="user" class="table table-bordered table-striped" style="clear: both">
									<tbody>
										...
										<tr>
											<td style="width:35%;"><span class="text-primary">申请人</span></td>
											<td style="width:65%"><span class="text-info"><?php echo ($data["info"]["emperson"]); ?></span></td>
										</tr>
										<tr>
											<td style="width:35%;"><span class="text-primary">指导老师</span></td>
											<td style="width:65%"><span class="text-info"><?php echo ($data["info"]["counselor"]); ?></span></td>
										</tr>
										<tr>
										...
										<tr>
											<td style="width:35%;"><span class="text-primary">借用场地</span></td>
											<td style="width:65%"><span class="text-info"><?php echo ($data["info"]["yname"]); ?></span></td>
										</tr>
										<tr>
